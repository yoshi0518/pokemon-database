...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  const PATH0 = '/ability';
  const PATH1 = '/egg-group';
  const PATH2 = '/gender';
  const PATH3 = '/growth-rate';
  const PATH4 = '/nature';
  const PATH5 = '/pokemon';
  const GET = 'GET';
  ...
  return {
    ...
    egg_group: {
      ...
      get: (option?: { query?: Methods_wsf7w5['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_wsf7w5['get']['resBody'], BasicHeaders, Methods_wsf7w5['get']['status']>(prefix, PATH1, GET, option).json(),
      $get: (option?: { query?: Methods_wsf7w5['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_wsf7w5['get']['resBody'], BasicHeaders, Methods_wsf7w5['get']['status']>(prefix, PATH1, GET, option).json().then(r => r.body),
    ...
    gender: {
      ...
      get: (option?: { query?: Methods_gsypk3['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_gsypk3['get']['resBody'], BasicHeaders, Methods_gsypk3['get']['status']>(prefix, PATH2, GET, option).json(),
      $get: (option?: { query?: Methods_gsypk3['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_gsypk3['get']['resBody'], BasicHeaders, Methods_gsypk3['get']['status']>(prefix, PATH2, GET, option).json().then(r => r.body),
    ...
    growth_rate: {
      ...
      get: (option?: { query?: Methods_5v1uhi['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_5v1uhi['get']['resBody'], BasicHeaders, Methods_5v1uhi['get']['status']>(prefix, PATH3, GET, option).json(),
      $get: (option?: { query?: Methods_5v1uhi['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_5v1uhi['get']['resBody'], BasicHeaders, Methods_5v1uhi['get']['status']>(prefix, PATH3, GET, option).json().then(r => r.body),
    ...
    nature: {
      ...
      get: (option?: { query?: Methods_edaidx['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_edaidx['get']['resBody'], BasicHeaders, Methods_edaidx['get']['status']>(prefix, PATH4, GET, option).json(),
      $get: (option?: { query?: Methods_edaidx['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_edaidx['get']['resBody'], BasicHeaders, Methods_edaidx['get']['status']>(prefix, PATH4, GET, option).json().then(r => r.body),
    ...
    pokemon: {
      get: (option?: { query?: Methods_xncz6f['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_xncz6f['get']['resBody'], BasicHeaders, Methods_xncz6f['get']['status']>(prefix, PATH5, GET, option).json(),
      $get: (option?: { query?: Methods_xncz6f['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_xncz6f['get']['resBody'], BasicHeaders, Methods_xncz6f['get']['status']>(prefix, PATH5, GET, option).json().then(r => r.body),
